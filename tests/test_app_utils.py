...
class TestAppUtils():
    """
    Meant for non-route utilities in chalicelib_cgap/app_utils.py
    """
    ...
    def test_get_favicon(self):
        ...
        expected = public_url_for_app('cgap') + '/static/img/favicon-fs.ico'  # favicon acquired from prod
    ...
    def test_check_jwt_authorization(self):
        ...
        with mock.patch('chalicelib_cgap.app_utils.AppUtils.get_jwt', return_value='token'):
